...
namespace BiometricIdentificationSystem
{
    ...
    /// </summary>
    public sealed partial class VIew_Admin_Pages : Page
    {
        public VIew_Admin_Pages()
        {
        ...
        private async void Page_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            ListUsers.ItemsSource = await Operations_Handler.GetUsers();
        ...
        private async void Search_parameter_TextChanged(object sender, TextChangedEventArgs e)
        {
            await Dispatcher.RunAsync(CoreDispatcherPriority.Low, () =>
            {
                ...
                ListUsers.ItemsSource = await Operations_Handler.GetUsers(search_options.SelectedIndex, search_parameter.Text);
